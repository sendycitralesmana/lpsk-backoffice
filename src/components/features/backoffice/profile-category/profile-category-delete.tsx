...
import { deleteNewsCategory } from "@/server/news-category"
import { deleteApplicationCategory } from "@/server/application-category-action"
import { deleteProfileCategory } from "@/server/profile-category-action"

export const ProfileCategoryDelete = ({ id }: { id: string }) => {
